...
- Learning how terminals actually work

It works primarily on **POSIX systems** (Linux/macOS). A compatibility layer exists for Windows, but advanced cursor/input control is POSIX-focused.
...
This project is currently intended for **local / editable use**.

```bash
git clone https://github.com/yourname/libTerm.git
cd libTerm
pip install -e .
````
